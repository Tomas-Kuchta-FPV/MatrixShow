...
SLEEP_INTERVAL = 20/2  # seconds between effects
EFFECTS_INTERVAL = 10/2 # seconds between effects
...
def main():
    ...
    while True:
        ...
        sleep(SLEEP_INTERVAL)
        LightEffects.blink_all_effect(70, BRIGHTNESS, 2, 1)
        sleep(SLEEP_INTERVAL/4)
        ...
        LightEffects.love_effect(0, BRIGHTNESS, EFFECTS_INTERVAL/8)
        sleep(SLEEP_INTERVAL)
        LightEffects.random_effect(True, 0.1, 300)
        sleep(SLEEP_INTERVAL/2)
        led_hal.set_all_off(2)
